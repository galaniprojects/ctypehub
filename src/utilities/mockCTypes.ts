...
export const mockCTypes: Record<string, CTypeData> = {
  example: {
    ...
    createdAt: new Date(Date.UTC(2023, 4, 1, 12)),
  ...
  nestedProperty: {
    ...
    type: 'object',
    creator: 'did:kilt:4pehddkhEanexVTTzWAtrrfo2R7xPnePpuiJLC7shQU894aY',
    createdAt: new Date(Date.UTC(2023, 4, 1, 12, 1)),
  ...
  nestedCType: {
    ...
    type: 'object',
    creator: 'did:kilt:4pehddkhEanexVTTzWAtrrfo2R7xPnePpuiJLC7shQU894aY',
    createdAt: new Date(Date.UTC(2023, 4, 1, 12, 2)),
    extrinsicHash: '0xexamplehash',
  ...
  everything: {
    ...
    extrinsicHash: '0xexamplehash',
    createdAt: new Date(Date.UTC(2023, 4, 1, 12, 3)),
    block: '456',
    isHidden: false,
  },
};
